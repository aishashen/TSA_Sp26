...
wind_data <- read.csv(file="/Users/meilishen/Documents/TimeSeries/TSA_Sp26/Data/Wind_Speed_PortArthurTX_Processed.csv",header=TRUE,stringsAsFactors = TRUE)
...
```{r}
ts_wind_data <- ts(wind_data$AWND.1,frequency=12, start=) 
